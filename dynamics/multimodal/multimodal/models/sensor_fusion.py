...
class SensorFusion(nn.Module):
    ...
    def forward_encoder(self, top_pcd, pose_in, property_in, next_pose_in):
        # Batch size
        ...
        #     print(top_pcd.shape)
        #     exit()
        #     top_pcd_list.append(top_pcd)
       
        out_top_pcd_list = self.pcd_encoder.encode(top_pcd)
...
class Dynamics_model(SensorFusion):
    ...
    def forward(
        ...
        letent_z = self.forward_encoder(top_pcd, pose_in, property_in, next_pose_in)
