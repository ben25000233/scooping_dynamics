...
class IsaacSim():
    ...
    def create_ball(self):
        ...
        self.domainInfo.set_domain_parameter_all_space(radius = 0.006, mass = 0.01, friction = 0.1)
    ...
    def create_franka(self):
        ...
        self.franka_start_pose.p = gymapi.Vec3(0, 0, 0)
    ...
    def add_franka(self, i, env_ptr):
        ...
        body_shape_prop = self.gym.get_actor_rigid_shape_properties(env_ptr, self.franka_handle)
        for k in range(11):
            body_shape_prop[k].thickness = 0.001
            body_shape_prop[k].friction = 0
        self.gym.set_actor_rigid_shape_properties(env_ptr, self.franka_handle, body_shape_prop)
    ...
    def reset(self):
        ...
        self.joint_state = []
        self.franka_init_pose = torch.tensor([0.0554, -0.7412,  0.0156, -2.4503, -0.0631,  1.7453,  0.8777,  0.02,  0.02], dtype=torch.float32, device=self.device)
    ...
    def data_collection(self):
        ...
        while not self.gym.query_viewer_has_closed(self.viewer):
            ...
            dpose = torch.Tensor([[[0.],[0.],[0.],[0.],[0.],[0.]]]).to(self.device) * delta
